  ...
  return (
    <View style={styles.container}>
      ...
      {context.trip.pickup_time === "null" ? (
        <TouchableOpacity onPress={pickup} style={styles.button}>
          <Text style={{ color: "#00a88a" }}>Pick up Passenger</Text>
        </TouchableOpacity>
      ) : (
        <TouchableOpacity onPress={dropOff} style={styles.button}>
          <Text style={{ color: "#00a88a" }}>Drop off Passenger</Text>
        </TouchableOpacity>
      )}
